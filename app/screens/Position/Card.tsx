...
import PositionContents from '@screens/Position/Contents'
import type {PositionOverviewType} from 'app/types/position'
import dynamic from 'next/dynamic'

const RemovePosition = dynamic(() => import('@screens/Position/Remove'))
const EditPosition = dynamic(() => import('@screens/Position/Edit'))
